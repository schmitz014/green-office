            ...
            <header className="bg-medium-green text-color-white font-poppins">
                <nav className="flex items-center justify-between mx-5">
                    <div className="flex items-center py-5 gap-5">
                        <img src="/public/Logo.svg" alt="Logo do Green Office" className="w-10 md:w-20 lg:w-28"/>
                        <h1 className="text-2xl md:text-5xl xl:text-6xl font-bold">GREENOFFICE</h1>
                    </div>
                    <div>
                        {/* Desktop */}
                        <ul className="lg:flex text-2xl hidden lg:gap-5">
                ...
                {/* Mobile */}
                {MobileMenu && (
                    <div className="flex flex-col items-center bg-medium-green text-color-white gap-y-5 p-5 text-xl">
                        <NavLink to="/">Home</NavLink>
                        <span className="block w-full h-1 md:w-20 md:h-2 bg-color-white"></span>
