...
export default function Solar() {
    return(
        <>
            ...
            <div className="font-poppins font-semibold m-10 flex gap-5 xl:text-4xl text-right">
                <img src="/public/img/Energies/solar.jpg" alt="Foto Energia Solar" className="xl:w-2/4 rounded-xl"/>
                <p>
